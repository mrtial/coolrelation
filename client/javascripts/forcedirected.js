(function(){
		...
		.directive('forceDirectedChart', function($window){
			return {
				...
				link:function(scope, elem, attrs){
					...
					scope.$watch(['chartData','chartOption'],function(){
	...
	function forceDirectedController($scope){
		// $scope.chartData = vm.chartData;
		// $scope.msg = "forceDirectedController HERE!"
	// 	$scope.data = {
	// 	  "nodes": [
	// 	    {"id": "Myriel", "group": 1},
	// 	    {"id": "Napoleon", "group": 1},
